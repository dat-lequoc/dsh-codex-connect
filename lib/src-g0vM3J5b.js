...
const SUPPORTED_DSH_PLUGIN_API_VERSION = "0.1.5-rc.1";
const SUPPORTED_DSH_PLUGIN_API_VERSIONS = [SUPPORTED_DSH_PLUGIN_API_VERSION];
...
const OPENAI_CODEX_RELEASE_API_BASE = "https://api.github.com/repos/dat-lequoc/dsh-codex-connect/releases/tags/v";
const OPENAI_CODEX_RELEASE_PAGE_BASE = "https://github.com/dat-lequoc/dsh-codex-connect/releases/tag/v";
const OPENAI_CODEX_UPDATE_HIGHLIGHTS_URL = "https://raw.githubusercontent.com/dat-lequoc/dsh-codex-connect/main/update-highlights.json";
...
//#endregion
export { readInstalledPackageVersion as $, assertNoOpenAICodexProviderConflict as A, normalizeTrustedOrigin as At, COMPATIBILITY_PACKAGES as B, OPENAI_CODEX_AUTH_DOCUMENT_LIMIT as Bt, OPENAI_CODEX_TRANSPORT_ERROR_CODES as C, resolveOpenAICodexSettings as Ct, isOpenAICodexTransportError as D, OPENAI_CODEX_FAST_MODE_MAX_SESSION_ID_LENGTH as Dt, OpenAICodexTransportError as E, OPENAI_CODEX_FAST_MODE_MAX_SESSIONS as Et, checkForOpenAICodexUpdate as F, loginOpenAICodex as Ft, SUPPORTED_DSH_PLUGIN_API_VERSION as G, openAICodexAuthPath as Gt, DSH_PLUGIN_API_PACKAGES as H, OPENAI_CODEX_AUTH_V1_BACKUP_SUFFIX as Ht, compareOpenAICodexVersions as I, logoutOpenAICodex as It, SUPPORTED_PI_AI_RANGE as J, SUPPORTED_DSH_PLUGIN_API_VERSIONS as K, parseOpenAICodexUpdateResult as L, openAICodexAuthStatus as Lt, openAICodexConflictMessage as M, parseOpenAICodexUsage as Mt, CODEX_CONNECT_VERSION as N, readOpenAICodexRateLimits as Nt, VIEW_IMAGE_TOOL_NAME as O, isFastModeSessionId as Ot, OPENAI_CODEX_UPDATE_PATH as P, openAICodexModelCatalog as Pt, isSupportedDshPluginApiVersion as Q, parseOpenAICodexVersion as R, publicAuthError as Rt, OPENAI_CODEX_TRANSPORT_API_VERSION as S, resolveOpenAICodexProxyUrl as St, OpenAICodexTransport as T, FastModeRegistry as Tt, PI_AI_PACKAGE as U, OPENAI_CODEX_PROVIDER as Ut, COMPATIBILITY_SCHEMA_VERSION as V, OPENAI_CODEX_AUTH_FILENAME as Vt, SUPPORTED_DSH_PLUGIN_API_RANGE as W, OpenAICodexCredentialStore as Wt, detectCompatibility as X, assessCompatibility as Y, evaluateCompatibility as Z, OPENAI_CODEX_IMAGE_MAX_COUNT as _, decodeOpenAICodexSettings as _t, name as a, OPENAI_CODEX_PROXY_PROBE_URL as at, OPENAI_CODEX_IMAGE_PROMPT_MAX_LENGTH as b, isValidOpenAICodexProxyUrl as bt, migrateOpenAICodexSearchHistory as c, listOpenAICodexProxyCandidates as ct, OPENAI_CODEX_BASE_URL as d, DEFAULT_OPENAI_CODEX_SEARCH_CONTEXT_SIZE as dt, OPENAI_CODEX_PROXY_DETECT_PATH as et, OPENAI_CODEX_SEARCH_PROVIDER as f, DEFAULT_OPENAI_CODEX_SEARCH_MAX_OUTPUT_TOKENS as ft, OPENAI_CODEX_IMAGE_GENERATION_URL as g, OPENAI_CODEX_SETTINGS_NAMESPACE as gt, mapOpenAICodexSearchResponse as h, DEFAULT_OPENAI_CODEX_SETTINGS as ht, inject as i, OPENAI_CODEX_PROXY_PROBE_TIMEOUT_MS as it, diagnoseOpenAICodex as j, OPENAI_CODEX_USAGE_URL as jt, IMAGE_GENERATE_TOOL_NAME as k, OpenAICodexTrustedOriginsStore as kt, CODEX_AUTO_REVIEW_MODEL as l, DEFAULT_OPENAI_CODEX_IMAGE_MODEL_HINT as lt, OpenAICodexSearchProvider as m, DEFAULT_OPENAI_CODEX_SEARCH_MODEL as mt, OPENAI_CODEX_SETTINGS_NS as n, OPENAI_CODEX_LOCAL_PROXY_CANDIDATES as nt, OPENAI_CODEX_HISTORY_BACKUP_SUFFIX as o, OpenAICodexProxyManager as ot, OPENAI_CODEX_SEARCH_URL as p, DEFAULT_OPENAI_CODEX_SEARCH_MODE as pt, SUPPORTED_NODE_RANGE as q, apply as r, OPENAI_CODEX_PROXY_CANDIDATE_LIMIT as rt, OPENAI_CODEX_SEARCH_MODEL_REQUEST_EVENT as s, detectOpenAICodexProxies as st, Config as t, OPENAI_CODEX_PROXY_TEST_PATH as tt, probeCodexAutoReview as u, DEFAULT_OPENAI_CODEX_PROXY_URL as ut, OPENAI_CODEX_IMAGE_MAX_ERROR_BYTES as v, isValidOpenAICodexContextWindowOverrides as vt, OPENAI_CODEX_TRANSPORT_SERVICE as w, OPENAI_CODEX_FAST_MODE_PATH as wt, OPENAI_CODEX_IMAGE_REQUEST_TIMEOUT_MS as x, normalizeOpenAICodexProxyUrl as xt, OPENAI_CODEX_IMAGE_MAX_RESPONSE_BYTES as y, isValidOpenAICodexImageModelHint as yt, COMPATIBILITY_CONTRACT as z, OPENAI_CODEX_ACCOUNT_LIMIT as zt };
