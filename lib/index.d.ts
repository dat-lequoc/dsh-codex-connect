...
declare const SUPPORTED_DSH_PLUGIN_API_VERSION = "0.1.5-rc.1";
declare const SUPPORTED_DSH_PLUGIN_API_VERSIONS: readonly ["0.1.5-rc.1"];
...
declare const SUPPORTED_PI_AI_RANGE = "0.85.1";
...
declare const COMPATIBILITY_CONTRACT: {
  ...
  readonly dshPluginApi: {
    readonly version: "0.1.5-rc.1";
    readonly versions: readonly ["0.1.5-rc.1"];
